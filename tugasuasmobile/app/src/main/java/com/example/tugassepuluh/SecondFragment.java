...
public class SecondFragment extends Fragment {
    ...
    private static final String YOUTUBE_VIDEO_ID_1 = "xM1CIQd_X4c";
    private static final String YOUTUBE_VIDEO_ID_2 = "SRWkG4ogJEc";
    private static final String YOUTUBE_VIDEO_ID_3 = "XjPdJEOYHfs";
    private static final String YOUTUBE_VIDEO_ID_4 = "r9NJveLN3zI";
