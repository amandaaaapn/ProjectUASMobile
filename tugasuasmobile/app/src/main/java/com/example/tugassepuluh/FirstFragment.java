...
public class FirstFragment extends Fragment {
    ...
    private static final String YOUTUBE_VIDEO_ID_1 = "l34Gwu6QaLQ";
    private static final String YOUTUBE_VIDEO_ID_2 = "IhXfUTGVEUI";
    private static final String YOUTUBE_VIDEO_ID_3 = "AdjedKX9nas";
    private static final String YOUTUBE_VIDEO_ID_4 = "sQQJEiESrK0";
